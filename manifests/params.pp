class puppetrepo::params {
  ...
  $puppetrepo_baseurl = "http://yum.puppetlabs.com/puppet5/el/${::operatingsystemmajrelease}/\$basearch"
  ...
  $puppetrepo_source_baseurl = "http://yum.puppetlabs.com/puppet5/el/${::operatingsystemmajrelease}/SRPMS"
